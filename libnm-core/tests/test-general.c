...
static void
test_setting_compare_cloned_mac_address (void)
{
	gs_unref_object NMSetting *old = NULL, *new = NULL;
	gboolean success;
...
int main (int argc, char **argv)
{
	...
	g_test_add_func ("/core/general/test_setting_compare_cloned_mac_address", test_setting_compare_cloned_mac_address);
